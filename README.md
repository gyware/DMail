...
## For Users
If you are just a regular windows user who wants to use DMail, it is recommended you download or run the [DMail HTA GUI](/HTA/GUI/DMail-HTA-GUI-VBScript-launcher.hta). You can run other GUI's, but the HTA GUI is the most complete.
