...
If customSMTP = "" Then
	...
	Do until success = True
		mail.Send
		If Err.Number <> 0 Then
			button = MsgBox("Error: mail send failed." & vbCrLf & "To: " & recipient & vbCrLf & "From: " & from & vbCrLf & "SMTP Server: " & SMTP & vbCrLf & "Port: 25" & vbCrLf & "Description: " & Err.Description, vbCritical + vbAbortRetryIgnore + vbDefaultButton2 + vbSystemModal, "DMail (VBScript)")
			Select Case button
			Case vbAbort
				WScript.Quit
			Case vbRetry
